...
own small filing.
ALSO FOUND + FIXED 2026-08-06 (same session, v1.0.608, revived and
merged 2026-08-21 after 15 days unmerged — PR #708's own branch never
landed; content cherry-picked onto a fresh branch this session, see
experiments.md's 2026-08-21 entry for the revival trace): the
"structurally starved" story above was itself incomplete. The
