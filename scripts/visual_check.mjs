...
const FIXTURES = {
  ...
  "/api/data/layers": {
    layers: [
      ...
      { id: "seafloor_confidence", name: "Seafloor mapping confidence (GEBCO)", kind: "raw", status: "live", field: true, group: "base", costTier: "moderate", source: "GEBCO/BODC public WMS", description: "Measured vs interpolated seafloor coverage, off by default." },
